...
import static cd4017be.lib.Content.aSSEMBLER;
...
public class ContainerAssembler extends AdvancedContainer {
	...
	public ModularGui<ContainerAssembler> setupGui(Inventory inv, Component name) {
		...
		.title("gui.cd4017be.assembler", 0.5F).background(TEX, 0, 0);
		...
		gui.slotTooltips.put(0, CFG_SERVER.canCutBlocks.get() ? "gui.cd4017be.destroy" : "gui.cd4017be.destroy_d");
		gui.slotTooltips.put(1, CFG_SERVER.canReplicate.get() ? "gui.cd4017be.replicate" : "gui.cd4017be.replicate_d");
